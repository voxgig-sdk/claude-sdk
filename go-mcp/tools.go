...
type Args struct {
	Entity string         `json:"entity" jsonschema:"message"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ClaudeSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "claude_list",
		Description: "List records from Claude. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "claude_load",
		Description: "Load a single record from Claude. " +
...
func runOp(client *sdk.ClaudeSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ClaudeSDK, name string) (sdk.ClaudeEntity, error) {
