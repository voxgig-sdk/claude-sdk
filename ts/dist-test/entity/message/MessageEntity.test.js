...
(0, node_test_1.describe)('MessageEntity', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('CLAUDE_TEST_LIVE'));
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.ClaudeSDK.test();
...
function basicSetup(extra) {
    ...
    let client = __1.ClaudeSDK.test(options, extra);
    ...
    if (live) {
        ...
        client = new __1.ClaudeSDK(merge([
