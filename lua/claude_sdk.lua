...
ClaudeSDK._make_feature = _make_feature


function ClaudeSDK.new(options)
  local self = setmetatable({}, ClaudeSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function ClaudeSDK:options_map()
...
function ClaudeSDK:get_utility()
  return Utility.copy(self._utility)
end


function ClaudeSDK:get_root_ctx()
  return self._rootctx
end


function ClaudeSDK:prepare(fetchargs)
...
function ClaudeSDK:direct(fetchargs)
...
-- by passing it.
function ClaudeSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function ClaudeSDK:graphql(query, variables, ctrl)
...
function ClaudeSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = ClaudeSDK.new(sdkopts)
  sdk.mode = "test"
