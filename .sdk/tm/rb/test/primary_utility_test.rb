...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = ClaudeOmni.make_runner(TEST_JSON_FILE, ClaudeSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : ClaudeOmni.errify(err)
    end
