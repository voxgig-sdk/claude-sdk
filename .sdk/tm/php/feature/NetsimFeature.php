...
class ClaudeNetsimFeature extends ClaudeBaseFeature
{
    ...
    private function _simulate(ClaudeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ClaudeContext $ctx, array $applied): void
    {
        $client = $this->client;
