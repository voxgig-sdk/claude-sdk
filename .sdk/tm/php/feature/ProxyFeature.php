...
class ClaudeProxyFeature extends ClaudeBaseFeature
{
    ...
    public function init(ClaudeContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ClaudeContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
