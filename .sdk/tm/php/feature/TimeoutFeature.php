...
class ClaudeTimeoutFeature extends ClaudeBaseFeature
{
    ...
    private function _with_timeout(ClaudeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ClaudeContext $_ctx, float $ms): void
    {
        $client = $this->client;
