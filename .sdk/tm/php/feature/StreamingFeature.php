...
class ClaudeStreamingFeature extends ClaudeBaseFeature
{
    ...
    private function _iterate(ClaudeResult $result): \Generator
    {
    ...
    private function _streamable(ClaudeContext $ctx): bool
    {
