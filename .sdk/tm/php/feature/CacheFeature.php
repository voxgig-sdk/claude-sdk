...
class ClaudeCacheFeature extends ClaudeBaseFeature
{
    ...
    private function _through(ClaudeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
