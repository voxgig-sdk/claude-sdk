...
// Claude SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ClaudeTestFeature extends ClaudeBaseFeature
{
    ...
    public function init(ClaudeContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ClaudeContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ClaudeContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ClaudeContext $ctx, $op, $args): array
    {
