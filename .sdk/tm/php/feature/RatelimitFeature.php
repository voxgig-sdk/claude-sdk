...
class ClaudeRatelimitFeature extends ClaudeBaseFeature
{
    ...
    private function _acquire(ClaudeContext $ctx): void
    {
    ...
    private function _track(ClaudeContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
