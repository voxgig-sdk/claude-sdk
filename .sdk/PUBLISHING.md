...
|---|---|---|
| `ts/` | @voxgig-sdk/claude-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/claude-sdk \
      --repository voxgig-sdk/claude-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/claude-sdk` shows it, and
`npm trust revoke @voxgig-sdk/claude-sdk --id=<id>` removes it.
