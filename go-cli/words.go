...
func registerSDKWords(r *eng.Registry, client *sdk.ClaudeSDK) {
...
func runOp(client *sdk.ClaudeSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
