...
This is an unofficial SDK for the Claude public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/claude` | `npm install @voxgig-sdk/claude` |
| Python | `voxgig-sdk-claude` | `pip install voxgig-sdk-claude` |
| PHP | `voxgig-sdk/claude` | `composer require voxgig-sdk/claude` |
| Golang | `github.com/voxgig-sdk/claude-sdk/go` | `go get github.com/voxgig-sdk/claude-sdk/go` |
| Ruby | `voxgig-sdk-claude` | `gem install voxgig-sdk-claude` |
| Lua | `voxgig-sdk-claude` | `luarocks install voxgig-sdk-claude` |
