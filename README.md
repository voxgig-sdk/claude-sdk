...
The Claude API enables developers to integrate advanced AI capabilities into their applications.

Learn more about Claude API at [anthropic.com](https://anthropic.com).
...
This SDK exposes the API as a small set of **semantic entities** — Message — that you
