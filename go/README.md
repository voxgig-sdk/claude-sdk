...
The Golang SDK for the Claude API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/claude-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/claude-sdk=../path/to/github.com/voxgig-sdk/claude-sdk
```
...
import (
    ...
    sdk "github.com/voxgig-sdk/claude-sdk"
...
```go
// Create
created, _ := client.Message(nil).Create(
...
```
github.com/voxgig-sdk/claude-sdk/
...
The root package (`github.com/voxgig-sdk/claude-sdk`) re-exports everything needed
