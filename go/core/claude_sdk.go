...
func (sdk *ClaudeSDK) OptionsMap() map[string]any {
...
func (sdk *ClaudeSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ClaudeSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ClaudeSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ClaudeSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ClaudeSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ClaudeSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ClaudeSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ClaudeSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ClaudeSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ClaudeSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
