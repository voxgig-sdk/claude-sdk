...
The PHP SDK for the Claude API. Provides an entity-oriented interface using PHP conventions.
...
```php
// Create
[$created, $_] = $client->Message(null)->create(["name" => "Example"], null);
...
[$result, $err] = $client->Claude(null)->load(
    ["id" => "test01"], null
);
