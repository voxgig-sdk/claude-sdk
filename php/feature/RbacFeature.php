...
class ClaudeRbacFeature extends ClaudeBaseFeature
{
    ...
    private function _required(ClaudeContext $ctx): ?string
    {
    ...
    private function _reject(ClaudeContext $ctx, string $required): void
    {
    ...
    private function _track(ClaudeContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
