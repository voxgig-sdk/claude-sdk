...
// Claude SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ClaudeMakeRequest
{
    public static function call(ClaudeContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ClaudeResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ClaudeResponse($fetched);
        } else {
