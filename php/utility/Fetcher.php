...
class ClaudeFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ClaudeSDK/1.0)';
    ...
    public static function call(ClaudeContext $ctx, string $fullurl, array $fetchdef): array
    {
