...
// Claude SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ClaudeOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ClaudeOmni::structfix($now, Struct::undef()))
                        !== json_encode(ClaudeOmni::structfix($val, Struct::undef()))) {
