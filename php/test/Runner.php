...
class ClaudeTestRunner
{
    ...
    {
        $live = self::getenv('CLAUDE_TEST_LIVE');
        $override = self::getenv('CLAUDE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CLAUDE_TEST_EXPLAIN');
...
class_alias('ClaudeTestRunner', 'Runner');
class_alias('ClaudeHelpers', 'Helpers');
