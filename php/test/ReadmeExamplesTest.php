...
// Claude SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ClaudeSDK::test)
...
{
    private const SDK_CLASS = 'ClaudeSDK';
    ...
    private const SDK_BASE = 'claude_sdk';
