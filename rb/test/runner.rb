...
module ClaudeTestRunner
  ...
  def self.env_override(m)
    live = getenv("CLAUDE_TEST_LIVE")
    override = getenv("CLAUDE_TEST_OVERRIDE")
    ...
    explain = getenv("CLAUDE_TEST_EXPLAIN")
    m["CLAUDE_TEST_EXPLAIN"] = explain if explain && !explain.empty?
