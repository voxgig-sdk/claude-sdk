...
The Python SDK for the Claude API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Message()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/claude-sdk/releases)) or
...
The main module (`claude_sdk`) exports the SDK class.
