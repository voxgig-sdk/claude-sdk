...
from claude_sdk.utility import register

# Load features
from claude_sdk.feature.base_feature import ClaudeBaseFeature
from claude_sdk.features import _has_feature, _make_feature
...
class ClaudeSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = ClaudeUtility()
        self._utility = utility

        from claude_sdk.config import shared_config
    ...
    def get_utility(self):
        return ClaudeUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ClaudeSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Message(self, data=None) -> "MessageEntity":
        ...
        from claude_sdk.entity.message_entity import MessageEntity
