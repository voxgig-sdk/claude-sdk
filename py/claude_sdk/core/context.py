...
from claude_sdk.core.helpers import get_ctx_prop, to_map
...
class ClaudeContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, ClaudeResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ClaudeError(code, msg, self)
