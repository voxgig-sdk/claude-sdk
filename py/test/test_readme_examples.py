# Claude SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ClaudeSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ClaudeSDK(...) and ClaudeSDK.test(...) become
#      ClaudeSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "claude_sdk"
_SDK_CLASS = "ClaudeSDK"
